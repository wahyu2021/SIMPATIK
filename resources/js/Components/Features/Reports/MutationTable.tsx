...
export default function MutationTable({ categories, summary, period, signatory, signerName }: Props) {
            ...
            <div className="overflow-x-auto">
                <table className="w-full text-xs">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {categories.map((cat) => (
                            <CategoryGroup key={cat.id} category={cat} fmtQty={fmtQty} />
                        ))}
                    </tbody>
                    <tfoot>
...
function CategoryGroup({ category, fmtQty }: {
