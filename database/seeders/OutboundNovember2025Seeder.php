...
class OutboundNovember2025Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/outbound_november_2025.csv');
        ...
        while (count($outboundItems) > 0) {
            ...
            $date = Carbon::parse('2025-11-01')->addDays(rand(0, 29))->setHour(rand(8, 15))->setMinute(rand(0, 59));
