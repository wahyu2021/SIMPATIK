...
class InboundNovember2025Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/inbound_november_2025.csv');
        ...
        $transaction = InboundTransaction::create([
            'user_id' => $userId,
            'reference_number' => 'IN-NOV-2025-001',
            'transaction_date' => '2025-11-28',
            'receipt_image_path' => 'receipts/dummy-receipt.jpg',
            'notes' => 'Seeding Barang Masuk November 2025'
        ]);
