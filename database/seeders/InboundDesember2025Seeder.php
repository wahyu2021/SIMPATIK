...
class InboundDesember2025Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/inbound_desember_2025.csv');
        ...
        $transaction = InboundTransaction::create([
            'user_id' => $userId,
            'reference_number' => 'IN-DEC-2025-001',
            'transaction_date' => '2025-12-30',
            'receipt_image_path' => 'receipts/dummy-receipt.jpg',
            'notes' => 'Seeding Barang Masuk Desember 2025'
        ]);
