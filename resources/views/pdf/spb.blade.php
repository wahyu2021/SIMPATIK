        ...
        <tr>
            <td class="signature-box" style="width: {{ $outbound->is_direct_request ? '50%' : '33%' }}">
                ...
                @php
                    ...
                    $requesterQr = base64_encode(SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')->size(240)->margin(0)->errorCorrection('H')->merge(public_path('images/logo.png'), 0.3, true)->generate($requesterInfo));
                @endphp
            ...
            <td class="signature-box" style="width: {{ $outbound->is_direct_request ? '50%' : '33%' }}">
                ...
                @php
                    ...
                    $issuerQr = base64_encode(SimpleSoftwareIO\QrCode\Facades\QrCode::format('png')->size(240)->margin(0)->errorCorrection('H')->merge(public_path('images/logo.png'), 0.3, true)->generate($issuerInfo));
                @endphp
