...
class InboundApril2026Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/inbound_april_2026.csv');
        ...
        $transaction = InboundTransaction::create([
            'user_id' => $userId,
            'reference_number' => 'IN-APR-2026-001',
            'transaction_date' => '2026-04-30',
            'receipt_image_path' => 'receipts/dummy-receipt.jpg',
            'notes' => 'Seeding Barang Masuk April 2026'
        ]);
