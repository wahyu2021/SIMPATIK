...
/**
 * Request Validator: StoreInboundRequest
 *
 * [Fungsionalitas]
...
class StoreInboundRequest extends FormRequest
{
    ...
    {
        return [
            'reference_number'     => ['required', 'string', 'max:100', 'unique:inbound_transactions,reference_number'],
    ...
    public function messages(): array
    {
        return [
            ...
            'receipt_image.required'        => 'Bukti transaksi/nota wajib diunggah.',
