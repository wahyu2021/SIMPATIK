...
class OutboundJanuari2026Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/outbound_januari_2026.csv');
        ...
        while (count($outboundItems) > 0) {
            ...
            $date = Carbon::parse('2026-01-01')->addDays(rand(0, 30))->setHour(rand(8, 15))->setMinute(rand(0, 59));
            
            $transaction = OutboundTransaction::create([
                'requester_id' => $requester->id,
                'department_id' => $requester->department_id,
                'document_number' => 'OUT-JAN-2026-' . str_pad($docCounter++, 3, '0', STR_PAD_LEFT),
