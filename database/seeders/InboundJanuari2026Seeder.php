...
class InboundJanuari2026Seeder extends Seeder
{
    public function run()
    {
        $file = database_path('seeders/data/inbound_januari_2026.csv');
